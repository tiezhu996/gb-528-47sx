...
type DeviceVersionLock struct {
	DeviceID       uint   `json:"device_id"`
	DeviceCode     string `json:"device_code"`
	DeviceName     string `json:"device_name"`
	SafetyZone     string `json:"safety_zone"`
	ReviewVersion  uint   `json:"review_version"`
...
type CueDefinitionResponse struct {
	...
	DeviceLocks       []DeviceVersionLock `json:"device_locks"`
	DeviceLockStale   bool                `json:"device_lock_stale"`
	DeviceLockReason  string              `json:"device_lock_reason"`
	DeviceLockMissing bool                `json:"device_lock_missing"`
